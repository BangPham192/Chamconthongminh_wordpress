jQuery(document).ready(function($){
	...
	$('#wt_menu_primary_color_selector').ColorPicker({													
		onChange: function (hsb, hex, rgb) {
				$('#wt_menu_primary_color_selector div').css('backgroundColor', '#' + hex);
				$('#wt_menu_primary_color').val('#'+hex);
		}
	});
	
	$('#wt_menu_second_color_selector').ColorPicker({													
		onChange: function (hsb, hex, rgb) {
				$('#wt_menu_second_color_selector div').css('backgroundColor', '#' + hex);
				$('#wt_menu_second_color').val('#'+hex);
		}
	});
