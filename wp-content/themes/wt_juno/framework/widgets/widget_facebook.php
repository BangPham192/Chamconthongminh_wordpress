...
class wellthemes_facebook_widget extends WP_Widget {
	...
	{
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_facebook', 'description' => 'Displays Facebook like box in the sidebar of the theme.');
		
		/* Create the widget. */
		$this->WP_Widget('wellthemes_facebook_widget', 'Well Themes: Facebook Likebox', $widget_ops);
	}
	...
	function widget($args, $instance)
	{
		...
		<div class="fb-container">
			...
			<div>
				<iframe src="http://www.facebook.com/plugins/likebox.php?href=<?php echo urlencode($page_url); ?>&amp;width=<?php echo $width; ?>&amp;colorscheme=<?php echo $color_scheme; ?>&amp;border_color=%23ffffff&amp;show_faces=<?php echo $show_faces; ?>&amp;stream=<?php echo $show_stream; ?>&amp;show_border=false&amp;header=<?php echo $show_header; ?>&amp;height=<?php echo $height; ?>" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:<?php echo $width; ?>px; height: <?php echo $height; ?>px; " allowTransparency="true" show-border="false"></iframe>
