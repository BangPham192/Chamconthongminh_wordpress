...
class wellthemes_flickr_widget extends WP_Widget {
	...
	function wellthemes_flickr_widget() {
		/* Widget settings. */		
		$widget_ops = array('classname' => 'widget_flickr', 'description' => 'Displays Flickr stream in the sidebar or footer.' );
		
		/* Create the widget. */
		$this->WP_Widget('wellthemes_flickr_widget', 'Well Themes: Flickr Widget ', $widget_ops);
	}
